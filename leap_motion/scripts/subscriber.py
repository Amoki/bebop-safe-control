...
def callback_ros(data):
    ...
    #   jdehfvn= data.azerty
    #)
    print("Palm\t\tdirection[%s,%s,%s]\tnormal[%s,%s,%s]\tpalmpos[%s,%s,%s]\typr[%s,%s,%s]\t\n" % (
    ...
    print("Thumb\t\tmetacarpal[%s,%s,%s]\tproximal[%s,%s,%s]\tintermediate[%s,%s,%s]\tdistal[%s,%s,%s]\ttip[%s,%s,%s]\t\n" % (
    ...
    print("Index\t\tmetacarpal[%s,%s,%s]\tproximal[%s,%s,%s]\tintermediate[%s,%s,%s]\tdistal[%s,%s,%s]\ttip[%s,%s,%s]\t\n" % (
    ...
    print("Middle\t\tmetacarpal[%s,%s,%s]\tproximal[%s,%s,%s]\tintermediate[%s,%s,%s]\tdistal[%s,%s,%s]\ttip[%s,%s,%s]\t\n" % (
    ...
    print("Ring\t\tmetacarpal[%s,%s,%s]\tproximal[%s,%s,%s]\tintermediate[%s,%s,%s]\tdistal[%s,%s,%s]\ttip[%s,%s,%s]\t\n" % (
    ...
    print("Pinky\t\tmetacarpal[%s,%s,%s]\tproximal[%s,%s,%s]\tintermediate[%s,%s,%s]\tdistal[%s,%s,%s]\ttip[%s,%s,%s]\t\n" % (
